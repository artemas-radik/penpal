...
declare type AttributeLiteral = string | number | boolean | null | undefined;
declare type AttributeLiteralOrList = AttributeLiteral | AttributeLiteral[];
...
declare type AttributeDataType = 'string' | 'boolean' | 'number' | 'datetime' | 'list';
export declare type IdentifyOptions = {
    signature?: string;
};
...
declare type StringFilter = ((className: string) => boolean) | RegExp;
declare type StringFilters = StringFilter | StringFilter[];
